...
class Baby(object):
    ...
    def feed_baby(self):
        print('Thank you for for feeding baby', self.b, '.')
        self.counter = 0

    def hour_passes(self):
        b = self.b
        if self.counter == 0:
            print('Baby', b, 'is sleeping.')
        if self.counter == 1:
            print('Baby', b, 'is awake. Time for food.')
        if self.counter >= 2:
            print('Baby', b, 'is CRYING uncontrollably! Feed the Baby!')
